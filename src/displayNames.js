const DISPLAY_NAME_MAP = {
    ...
    Longshot: '远袭者',
    Mega_Tesla: '超级特斯拉电磁塔',
    Merged_Archer_Cannon: '复合机械塔',
    Merged_Archer_Tower: '多人箭塔',
    Merged_Cannon: '跳弹加农炮',
    Minion_Prince: '亡灵王子',
    Monolith: '巨石碑',
    Mortar: '迫击炮',
